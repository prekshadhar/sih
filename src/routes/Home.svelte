    ...
    <div class="flex items-start gap-12">
      <div class="flex-1">
        ...
        <p class="text-gray-700 leading-relaxed max-w-2xl pl-52">
          We help students access their academic level by conducting personalized tests. After evaluating their performance, we provide a detailed roadmap and review to highlight their strengths and areas for improvement.
          <br><br>
